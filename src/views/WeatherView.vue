        ...
        <div class="col-md-8 col-lg-6">
          <div class="weather-card p-4 p-md-5">
            ...
            <div class="text-center mb-4 border-bottom border-secondary pb-3">
              <h3 class="location-name mb-1">{{ searchArea === "" ? 'Current Location' : data.location.name }}</h3>
              <p class="date-text mb-0">{{ formatDate(data.data.time) }}</p>
            </div>
            <!-- temperature -->
            <div class="main-temp text-center mb-4">
              <h1 class="display-1 fw-bold mb-0">
                {{ Math.round(data.data.values.temperature) }}<span class="celsius">°C</span>
              </h1>
              <p class="feels-like mt-2">
                Feels like {{ Math.round(data.data.values.temperatureApparent) }}°C
              </p>
            </div>
            <!-- anther info  -->
            <div class="row text-center details-grid pt-3">
              <div class="col-4">
                <div class="detail-item">
                  <span class="detail-icon"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-moisture" viewBox="0 0 16 16"><path d="M13.5 0a.5.5 0 0 0 0 1H15v2.75h-.5a.5.5 0 0 0 0 1h.5V7.5h-1.5a.5.5 0 0 0 0 1H15v2.75h-.5a.5.5 0 0 0 0 1h.5V15h-1.5a.5.5 0 0 0 0 1h2a.5.5 0 0 0 .5-.5V.5a.5.5 0 0 0-.5-.5zM7 1.5l.364-.343a.5.5 0 0 0-.728 0l-.002.002-.006.007-.022.023-.08.088a29 29 0 0 0-1.274 1.517c-.769.983-1.714 2.325-2.385 3.727C2.368 7.564 2 8.682 2 9.733 2 12.614 4.212 15 7 15s5-2.386 5-5.267c0-1.05-.368-2.169-.867-3.212-.671-1.402-1.616-2.744-2.385-3.727a29 29 0 0 0-1.354-1.605l-.022-.023-.006-.007-.002-.001zm0 0-.364-.343zm-.016.766L7 2.247l.016.019c.24.274.572.667.944 1.144.611.781 1.32 1.776 1.901 2.827H4.14c.58-1.051 1.29-2.046 1.9-2.827.373-.477.706-.87.945-1.144zM3 9.733c0-.755.244-1.612.638-2.496h6.724c.395.884.638 1.741.638 2.496C11 12.117 9.182 14 7 14s-4-1.883-4-4.267"/></svg></span>
                  <h5 class="detail-value mb-0">{{ data.data.values.humidity }}%</h5>
                  <small class="detail-label">Humidity</small>
                </div>
              </div>
              <div class="col-4 border-start border-end border-secondary">
                <div class="detail-item">
                  <span class="detail-icon"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-wind" viewBox="0 0 16 16"><path d="M12.5 2A2.5 2.5 0 0 0 10 4.5a.5.5 0 0 1-1 0A3.5 3.5 0 1 1 12.5 8H.5a.5.5 0 0 1 0-1h12a2.5 2.5 0 0 0 0-5m-7 1a1 1 0 0 0-1 1 .5.5 0 0 1-1 0 2 2 0 1 1 2 2h-5a.5.5 0 0 1 0-1h5a1 1 0 0 0 0-2M0 9.5A.5.5 0 0 1 .5 9h10.042a3 3 0 1 1-3 3 .5.5 0 0 1 1 0 2 2 0 1 0 2-2H.5a.5.5 0 0 1-.5-.5"/></svg></span>
                  <h5 class="detail-value mb-0">{{ data.data.values.windSpeed }} m/s</h5>
                  <small class="detail-label">Wind</small>
                </div>
              </div>
              <div class="col-4">
                <div class="detail-item">
                  <span class="detail-icon"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-cloud-fill" viewBox="0 0 16 16"><path d="M4.406 3.342A5.53 5.53 0 0 1 8 2c2.69 0 4.923 2 5.166 4.579C14.758 6.804 16 8.137 16 9.773 16 11.569 14.502 13 12.687 13H3.781C1.708 13 0 11.366 0 9.318c0-1.763 1.266-3.223 2.942-3.593.143-.863.698-1.723 1.464-2.383"/></svg></span>
                  <h5 class="detail-value mb-0">{{ data.data.values.cloudCover }}%</h5>
              ...
              <div class=" container justify-content-around row mt-5">
                <div class="col-6 col-sm-3">
                  <div class="detail-item">
                    <span class="detail-icon"><svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-cloud-rain-fill" viewBox="0 0 16 16"><path d="M4.158 12.025a.5.5 0 0 1 .316.633l-.5 1.5a.5.5 0 1 1-.948-.316l.5-1.5a.5.5 0 0 1 .632-.317m3 0a.5.5 0 0 1 .316.633l-1 3a.5.5 0 1 1-.948-.316l1-3a.5.5 0 0 1 .632-.317m3 0a.5.5 0 0 1 .316.633l-.5 1.5a.5.5 0 1 1-.948-.316l.5-1.5a.5.5 0 0 1 .632-.317m3 0a.5.5 0 0 1 .316.633l-1 3a.5.5 0 1 1-.948-.316l1-3a.5.5 0 0 1 .632-.317m.247-6.998a5.001 5.001 0 0 0-9.499-1.004A3.5 3.5 0 1 0 3.5 11H13a3 3 0 0 0 .405-5.973"/></svg></span>
                    <h5 class="detail-value mb-0">{{ data.data.values.precipitationProbability }}%</h5>
                    <small class="detail-label">Rain Probability</small>
                  </div>
                </div>
                <div class="col-6 col-sm-3">
                  <div class="detail-item">
                    <span class="detail-icon">{{ getWeatherCondition(`${data.data.values.weatherCode}`,"icon") }}</span>
                    <h5 class="detail-value mb-0">{{ getWeatherCondition(`${data.data.values.weatherCode}`,"text") }}</h5>
                  </div>
                </div>
              </div>
            </div>
